          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-4">
                <li>
                  <button 
                    onClick={() => window.open("https://amazon.com/Questions-That-Insurance-Agents-Themselves/dp/0972437614", "_blank")}
                ...
                <li>
                  <button 
                    onClick={() => window.open("https://amazon.com/Life-Insurance-Selling-Strategies-Professionals/dp/1934354007", "_blank")}
                    className="flex items-center text-blue-600 hover:text-blue-800 font-medium"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
